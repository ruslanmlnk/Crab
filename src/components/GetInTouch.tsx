      ...
      <div className="relative z-10 w-full h-full flex justify-center items-center">
        <div className="w-full max-w-[1350px] px-6 h-full grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center h-full">
            <GetInTouchContent contactHref={contactHref} messages={messages} />
          </div>
        </div>
      </div>
    </section>
...
const GetInTouchContent: React.FC<GetInTouchContentProps> = ({
  contactHref,
  messages,
}) => (
  <motion.div
    ...
    <div className="flex flex-col gap-12 md:gap-[56px]">
      <div className="flex justify-between items-start gap-4">
        ...
        <div className="relative w-[140px] h-[70px] md:w-[200px] md:h-[100px] overflow-hidden rounded-[2px] flex-shrink-0">
          <Image
            src="/images/backgrounds/getintouch.png"
            alt="Underwater"
            fill
            className="object-cover"
          />
      ...
      <div className="flex flex-col gap-12 md:gap-[56px]">
        ...
        <Link
          href={contactHref}
          className="flex items-center gap-2 group cursor-pointer w-fit transition-opacity hover:opacity-80"
        >
